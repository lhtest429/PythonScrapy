...
Object.defineProperties(Navigator.prototype, {
  ...
  userAgent: {get(){ v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36");return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36" }},
  ...
  hardwareConcurrency: {get(){ v_console_log("  [*] Navigator -> hardwareConcurrency[get]", 20);return 20 }},
  ...
  appVersion: {get(){ v_console_log("  [*] Navigator -> appVersion[get]", "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36");return "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36" }},
...
Object.defineProperties(PerformanceEntry.prototype, {
  ...
  startTime: {get(){ v_console_log("  [*] PerformanceEntry -> startTime[get]", 269.19999999995343);return 269.19999999995343 }},
  duration: {get(){ v_console_log("  [*] PerformanceEntry -> duration[get]", 1.5999999998603016);return 1.5999999998603016 }},
...
Object.defineProperties(webkitURL.prototype, {
  origin: {get(){ v_console_log("  [*] webkitURL -> origin[get]", "https://t2.xiaohongshu.com");return "https://t2.xiaohongshu.com" }},
  href: {get(){ v_console_log("  [*] webkitURL -> href[get]", "https://edith.xiaohongshu.com/api/sns/web/unread_count");return "https://edith.xiaohongshu.com/api/sns/web/unread_count" }},
...
Object.defineProperties(History.prototype, {
  ...
  scrollRestoration: {set(){ v_console_log("  [*] History -> scrollRestoration[set]", [].slice.call(arguments));return 5 }},
...
Object.defineProperties(PerformanceResourceTiming.prototype, {
  ...
  responseEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseEnd[get]", 2564.2999999998137);return 2564.2999999998137 }},
  ...
  domainLookupEnd: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupEnd[get]", 1.6999999999534339);return 1.6999999999534339 }},
  domainLookupStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> domainLookupStart[get]", 1.6999999999534339);return 1.6999999999534339 }},
  ...
  fetchStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> fetchStart[get]", 1257.3999999999069);return 1257.3999999999069 }},
...
Object.defineProperties(DOMRect.prototype, {
  width: {get(){ v_console_log("  [*] DOMRect -> width[get]", 64);return 64 }},
  height: {get(){ v_console_log("  [*] DOMRect -> height[get]", 40);return 40 }},
...
Object.defineProperties(MediaQueryList.prototype, {
  ...
  onchange: {set(){ v_console_log("  [*] MediaQueryList -> onchange[set]", [].slice.call(arguments));return true }},
...
Object.defineProperties(Screen.prototype, {
  ...
  height: {get(){ v_console_log("  [*] Screen -> height[get]", 960);return 960 }},
  availWidth: {get(){ v_console_log("  [*] Screen -> availWidth[get]", 1707);return 1707 }},
  availHeight: {get(){ v_console_log("  [*] Screen -> availHeight[get]", 898);return 898 }},
...
Object.defineProperties(TransitionEvent.prototype, {
  propertyName: {get(){ v_console_log("  [*] TransitionEvent -> propertyName[get]", "background-color");return "background-color" }},
...
Object.defineProperties(NetworkInformation.prototype, {
  ...
  rtt: {get(){ v_console_log("  [*] NetworkInformation -> rtt[get]", 100);return 100 }},
...
Object.defineProperties(LayoutShift.prototype, {
  ...
  value: {get(){ v_console_log("  [*] LayoutShift -> value[get]", 0.0000015394708415037536);return 0.0000015394708415037536 }},
...
Object.defineProperties(Element.prototype, {
  ...
  clientHeight: {get(){ v_console_log("  [*] Element -> clientHeight[get]", 323);return 323 }},
  tagName: {get(){ v_console_log("  [*] Element -> tagName[get]", this.v_tagName);return this.v_tagName }},
  scrollTop: {set(){ v_console_log("  [*] Element -> scrollTop[set]", [].slice.call(arguments));return "LI" }},
  clientWidth: {get(){ v_console_log("  [*] Element -> clientWidth[get]", 1445);return 1445 }},
  scrollWidth: {get(){ v_console_log("  [*] Element -> scrollWidth[get]", 1445);return 1445 }},
  ...
  className: {set(){ v_console_log("  [*] Element -> className[set]", [].slice.call(arguments));return 0 }},
...
Object.defineProperties(PerformanceNavigationTiming.prototype, {
  ...
  domInteractive: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domInteractive[get]", 261.5999999998603);return 261.5999999998603 }},
  domContentLoadedEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventStart[get]", 798.8999999999069);return 798.8999999999069 }},
  loadEventStart: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventStart[get]", 1434.8999999999069);return 1434.8999999999069 }},
  domContentLoadedEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> domContentLoadedEventEnd[get]", 799.0999999998603);return 799.0999999998603 }},
  loadEventEnd: {get(){ v_console_log("  [*] PerformanceNavigationTiming -> loadEventEnd[get]", 1438.0999999998603);return 1438.0999999998603 }},
...
Object.defineProperties(HTMLElement.prototype, {
  ...
  offsetWidth: {get(){ v_console_log("  [*] HTMLElement -> offsetWidth[get]", 1445);return 1445 }},
  offsetLeft: {get(){ v_console_log("  [*] HTMLElement -> offsetLeft[get]", 627);return 627 }},
...
Object.defineProperties(HTMLScriptElement.prototype, {
  src: {get(){ v_console_log("  [*] HTMLScriptElement -> src[get]", "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js");return "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js" },set(){ v_console_log("  [*] HTMLScriptElement -> src[set]", [].slice.call(arguments));return "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js" }},
  type: {set(){ v_console_log("  [*] HTMLScriptElement -> type[set]", [].slice.call(arguments));return "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js" }},
  crossOrigin: {set(){ v_console_log("  [*] HTMLScriptElement -> crossOrigin[set]", [].slice.call(arguments));return "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js" }},
  charset: {set(){ v_console_log("  [*] HTMLScriptElement -> charset[set]", [].slice.call(arguments));return "https://fe-video-qc.xhscdn.com/fe-platform/b44200b8a26b72242ecccf4320cb84570d493d13.js" }},
...
Object.defineProperties(HTMLLinkElement.prototype, {
  rel: {get(){ v_console_log("  [*] HTMLLinkElement -> rel[get]", "apple-touch-icon");return "apple-touch-icon" },set(){ v_console_log("  [*] HTMLLinkElement -> rel[set]", [].slice.call(arguments));return "apple-touch-icon" }},
  type: {set(){ v_console_log("  [*] HTMLLinkElement -> type[set]", [].slice.call(arguments));return "apple-touch-icon" }},
  href: {set(){ v_console_log("  [*] HTMLLinkElement -> href[set]", [].slice.call(arguments));return "apple-touch-icon" }},
...
function _createElement(name){
  var htmlmap = {"HTMLElement":["abbr","address","article","aside","b","bdi","bdo","cite","code","dd","dfn","dt","em","figcaption","figure","footer","header","hgroup","i","kbd","main","mark","nav","noscript","rp","rt","ruby","s","samp","section","small","strong","sub","summary","sup","u","var","wbr"],"HTMLScriptElement":["script"],"HTMLCanvasElement":["canvas"],"HTMLImageElement":["img"],"HTMLInputElement":["input"],"HTMLAnchorElement":["a"],"HTMLLinkElement":["link"],"HTMLButtonElement":["button"],"HTMLIFrameElement":["iframe"],"HTMLTemplateElement":["template"],"HTMLHeadElement":["head"],"HTMLBodyElement":["body"],"HTMLMediaElement":[],"HTMLUnknownElement":[]}
...
init_cookie("a1=18b27f14376e7669cnl8hf38gxbizafbv0xde5jn950000308366; webId=a3d75fe8354ceae8a0842f1dcdcb3e3c; abRequestId=a3d75fe8354ceae8a0842f1dcdcb3e3c; gid=yYDJWiy242h8yYDJWiy4q82VWKdWKKjSI1YxCIjiqYkCDf283u0iDd888q8YqKK8fDqdY0qy; sensorsdata2015jssdkcross=%7B%22%24device_id%22%3A%2218d21055ad0a54-0dfe45ca082bd3-26031051-1638720-18d21055ad1cc4%22%7D; xsecappid=xhs-pc-web; webBuild=4.1.2; unread={%22ub%22:%226586abf900000000090273d8%22%2C%22ue%22:%2265af9b1e000000002c0280f4%22%2C%22uc%22:21}; cache_feeds=[]; websectiga=82e85efc5500b609ac1166aaf086ff8aa4261153a448ef0be5b17417e4512f28; sec_poison_id=bc78a9d3-b4c8-49e8-9b85-d74160065145")
v_hook_href(window.location, 'location', "https://www.xiaohongshu.com/user/profile/5fc31a09000000000101fdec")
Location.prototype.toString = v_saf(function toString(){ return "https://www.xiaohongshu.com/user/profile/5fc31a09000000000101fdec" })
...
window.innerWidth = 2561
window.innerHeight = 1217
window.outerHeight = 898
...
function v_getele(name, func){
  ...
  if(name == "#link-guide" && func == "querySelector"){ return v_new(HTMLAnchorElement) }
  return null
}
function v_geteles(name, func){
  ...
  if(name == "link" && func == "getElementsByTagName"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  if(name == "style" && func == "getElementsByTagName"){ return [v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement)] }
